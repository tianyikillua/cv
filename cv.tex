...
\begin{itemize}
\item Multiscale rheological (fluid) and mechanical (solid) modeling of fiber-reinforced polymers: anisotropic viscosity, porosity prediction and material failure behavior
...
\cvevent{Junior Research Engineer (PhD Candicate)}{\href{http://www.imsia.cnrs.fr}{IMSIA (CNRS-EDF-CEA)} \hfill\textcolor{body}{\normalfont PME -- applied research lab}}{Oct 2013 -- Sep 2016}{Palaiseau (91), FRANCE}
\begin{itemize}
